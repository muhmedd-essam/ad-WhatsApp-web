...
import { Employeelogin as authLogin } from "../../services/authService";
...
const EmployeeLogin = () => {
  ...
  const {savePermissions}=useContext(PermissionsContext)
  const {
    register,
    handleSubmit,
    formState: { errors },
        ...
        <div className="row">
          <div className="col-md-6">
            <form onSubmit={handleSubmit(onSubmit)} className="m-auto">
              <h2 className="text-dark">تسجيل الموظفين</h2>
